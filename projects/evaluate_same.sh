...
nohup python gym-donkeycar/examples/reinforcement_learning/ddqn.py --gpu 0 --eps 5 --model "model/cnnedit1_lstm_reorder_lanesegment_run1.h5" --debug_mode=0 --test --max_ep_len=1000 --port 9080 --lane_segment=1 --keep_ratio=0 --image_rescale=0 --model_name="cnnedit1_lstm_reorder" > same/cnnedit1_lstm_reorder_lanesegment_run1.out ; 

nohup python gym-donkeycar/examples/reinforcement_learning/ddqn.py --gpu 0 --eps 5 --model "model/cnnedit1_lstm_reorder_nolanesegment_run1.h5" --debug_mode=0 --test --max_ep_len=1000 --port 9080 --lane_segment=0 --keep_ratio=0 --image_rescale=0 --model_name="cnnedit1_lstm_reorder" > same/cnnedit1_lstm_reorder_nolanesegment_run1.out ; 
...
nohup python gym-donkeycar/examples/reinforcement_learning/ddqn.py --gpu 0 --eps 5 --model "model/cnnedit4_lstm_lanesegment_run1.h5" --debug_mode=0 --test --max_ep_len=1000 --port 9080 --lane_segment=1 --keep_ratio=0 --image_rescale=0 --model_name="cnnedit4_lstm" > same/cnnedit4_lstm_lanesegment_run1.out ;
